...
declare global {
  ...
  interface VisualLearnBridge {
    ...
    scanStudyNotes: (payload: {
      studyRoot: string
    }) => Promise<VisualLearnStudyCategory[]>
    /** 读取 Markdown 内容。 */
    readMdContent: (payload: {
      filePath: string
      studyRoot: string
    }) => Promise<string>
    /** 获取学习进度。 */
    ...
    getAnnotations: (payload: {
      filePath: string
    }) => Promise<VisualLearnAnnotation[]>
    /** 创建文章标注。 */
    createAnnotation: (
      payload: VisualLearnAnnotationInput
    ) => Promise<VisualLearnAnnotation>
    /** 更新文章标注。 */
    updateAnnotation: (
      payload: VisualLearnAnnotationUpdate
    ) => Promise<VisualLearnAnnotation>
    /** 删除文章标注。 */
    ...
    /** 获取所有文章总总结。 */
    getArticleSummaries: () => Promise<
      Record<string, VisualLearnArticleSummary>
    >
    /** 获取单篇文章总总结。 */
    getArticleSummary: (payload: {
      filePath: string
    }) => Promise<VisualLearnArticleSummary | null>
    /** 设置单篇文章总总结。 */
